...
<tr>
<td><?php echo $i++; ?></td>
<td><img class="img-responsive" src="<?php echo base_url() . 'asset/images/'.$item['gambar']; ?>"/></td>
...
<?php
		...
		{
			echo "<h5>Keranjang Kosong, Silahkan Berbelanja..</h5>";	
		}	
?>
<div class="alert alert-warning">
      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      Berbelanjalah dengan jujur
    </div>
</form>
